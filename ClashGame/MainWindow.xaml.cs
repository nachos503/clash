...
namespace ClashGame
{
    public partial class MainWindow : Window
    {
        ...
        private void UseWizard_Click(object sender, RoutedEventArgs e)
        {
            ...
            battleManager.WizardTurn(playerArmy, outputTextBox);
            wizardUsed = true;
            UseWizard.IsEnabled = false;
            RefreshUI();
        }
        ...
        private void UseHealer_Click(object sender, RoutedEventArgs e)
        {
            ...
            battleManager.HealerTurn(playerArmy, outputTextBox);
            healerUsed = true;
            UseHealer.IsEnabled = false;
            RefreshUI();
        }
        ...
        private void UseArcher_Click(object sender, RoutedEventArgs e)
        {
            ...
            battleManager.ArchersTurn(playerArmy, computerArmy, outputTextBox);
            archerUsed = true;
            UseArcher.IsEnabled = false;
            RefreshUI();
        }
        ...
        private void CancelTurn_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                battleManager.Attack(playerArmy[0], computerArmy[0], outputTextBox);
                battleManager.IsDead(computerArmy[0], computerArmy);
                CheckGameOver();
            }
        ...
        private void ComputerTurn()
        {
            ...
            {
                battleManager.TurnComputer(computerArmy, playerArmy, outputTextBox);
                CheckGameOver();
            }
        ...
        private void ToTheEnd_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                battleManager.TurnComputer(playerArmy, computerArmy, outputTextBox);
                CheckGameOver();
